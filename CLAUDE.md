...
- Test baseline: **765 items live** (was 353 at the 2026-07-18 snapshot, 520 at S1, 688 entering S6a — AMENDMENTS A10, A28); macOS **764 passed / 1 skipped**, re-measured 2026-08-01 at S6a completion. Count only goes up; existing tests untouched. **Measuring trap:** a PIPED `--collect-only` returns a wrapper line reading `Pytest: No tests collected`, which is not the real result — redirect to a file and read the file instead.
