...
7. **Never edit an existing test assertion.** Additions only. `test_release_decoupling.py` passes unmodified after every milestone — if a scaffold file trips it, the file moves, not the test.
